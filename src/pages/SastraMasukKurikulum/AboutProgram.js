                ...
                <div className="container p-3 py-5">
                    ...
                    <div className="row mt-4">
                        ...
                        <div className="col-lg-9">
                            ...
                            <p className="lh-lg">Penyusunan daftar rekomendasi tidak berhenti pada proses kurasi. Proses dilanjutkan dengan reviu dan penyusunan panduan penggunaan karya sastra oleh para guru dari berbagai mata pelajaran, jenjang, dan daerah dalam kurun waktu Februari-April 2024. Reviu oleh guru ini vital karena guru adalah calon pengguna program “Sastra Masuk Kurikulum” ini. Dalam prosesnya, ada beberapa usulan tim kurator yang tidak dapat ditindaklanjuti karena beberapa alasan seperti akses buku terbatas dan sudah langka serta penafian yang kelewat banyak. Pembatasan satu penulis satu karya juga muncul untuk memantik guru dan peserta didik mengeksplorasi karya lain dari penulis tersebut.</p>
