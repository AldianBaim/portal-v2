    ...
    return (
        <section id="sidebar-kurikulum">
            <div className="d-flex flex-column">
                ...
                <Link to="/sastra-masuk-kurikulum/tahapan-kurasi" className={`${menuActive == 'tahapan-kurasi' && 'menu-active'} p-3 px-3 text-decoration-none text-dark`}>Tahapan Kurasi</Link>
