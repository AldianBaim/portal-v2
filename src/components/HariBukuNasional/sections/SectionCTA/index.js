            ...
            <div className="container p-3">
                <div className="row align-items-center justify-content-center text-center">
                    <div className="col-lg-7">
                        ...
                        <a href="https://static.buku.kemdikbud.go.id/content/pengumuman/Panduan.pdf" target="_blank" className="btn btn-orange rounded-pill px-4 py-2">Unduh Buku <FontAwesomeIcon icon={faDownload} className="ms-2" /></a>
                    </div>
                </div>
            </div>
        </section>
